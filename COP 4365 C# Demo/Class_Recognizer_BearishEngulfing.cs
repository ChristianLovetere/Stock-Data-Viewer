...
{
    /// <summary>
    /// Derived class from Recognizer to recognize the bearish engulfing pattern
    /// </summary>
    internal class Class_Recognizer_BearishEngulfing : Recognizer //derive from recognizer
    {
        ...
        /// </summary>
        public Class_Recognizer_BearishEngulfing() : base("BearishEngulfing", 2) { }
    }
}
