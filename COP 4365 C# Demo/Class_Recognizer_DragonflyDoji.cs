...
{
    /// <summary>
    /// Derived class from Recognizer to recognize the dragonfly doji pattern
    /// </summary>
    internal class Class_Recognizer_DragonflyDoji : Recognizer //derive from recognizer
    {
        public override bool Recognize(List<smartCandlestick> lscs, int currentIndex) //override abstract function
        {
            ...
            //if no data yet,
            bool r = (scs.bodyRange <= (decimal)0.15 * scs.range && scs.lowerTail >= (decimal)0.65 * scs.range); //Dragonfly pattern
            return r;
        }
        /// <summary>
        /// use Recognizer constructor
        /// </summary>
        public Class_Recognizer_DragonflyDoji() : base("DragonflyDoji", 1) { }
    }
}
