...
{
    /// <summary>
    /// Derived class from Recognizer to recognize the bullish engulfing pattern
    /// </summary>
    internal class Class_Recognizer_BullishEngulfing : Recognizer //derive from recognizer
    {
        public override bool Recognize(List<smartCandlestick> lscs, int currentIndex) //ovveride abstract function
        {
            ...
            //if the right scs starts higher and ends lower than the left, and the left is bearish, and the right is bullish
        ...
        /// </summary>
        public Class_Recognizer_BullishEngulfing() : base("BullishEngulfing", 2) { }
    }
}
