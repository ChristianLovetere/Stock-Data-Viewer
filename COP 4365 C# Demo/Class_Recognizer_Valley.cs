...
{
    /// <summary>
    /// Derived class from Recognizer to recognize the valley pattern. Adds isValley pattern to the candlestick to the immediate right of the actual valley
    /// </summary>
    internal class Class_Recognizer_Valley : Recognizer //derive from recognizer
    {
        ...
        /// </summary>
        public Class_Recognizer_Valley() : base("Valley", 3) { }
    }
}
